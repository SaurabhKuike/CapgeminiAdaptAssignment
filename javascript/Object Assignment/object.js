...
function Q5(){
    ...
    var info = {
     ...
     info.Middlename = "mani";
    document.write(`After defining The middle name is : ${info.Middlename}`);
};
 
function Q6(){
var string = "{firstName:'Raghavendra', age:21, city:'vijayawadai', state:'AP', country:'India'}";
eval('var obj='+string);
document.write(obj);
string.MiddleName = "kamal";
...
function Q7(){
var obj = '{ "firstName":"Raghavendra", "lastName":"kamal" }';
obj = JSON.parse(obj); 
document.write(obj);
};